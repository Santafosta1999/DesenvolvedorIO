...
public class Aluno
{
    ...
    [StringLength(30, MinimumLength = 2, ErrorMessage = "O campo {0} precisa ter entre {2} e {1} catacteres")]
    ...
    [Required(ErrorMessage = "O campo {0} é obrigatório")]
    [StringLength(60, ErrorMessage = "O campo {0} precisa ter no máximo {1} catacteres")]
